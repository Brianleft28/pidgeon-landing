...
export const ContactCTA: React.FC = () => {
  ...
  return (
    <section id="contact" className="min-h-[50vh] flex flex-col justify-center py-20 relative overflow-hidden">
      {/* Background Decor */}
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="mt-16 flex justify-center gap-8 text-slate-500 text-sm font-medium items-center">
             <span>Buenos Aires, AR</span>
             <span className="w-1 h-1 rounded-full bg-slate-700"></span>
             <a href="mailto:soporte@pidgeonsolutions.com" className="hover:text-emerald-400 transition-colors">
                soporte@pidgeonsolutions.com
             </a>
          </div>
        </div>
      </div>
